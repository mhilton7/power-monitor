...
Database migration: `20260720_0003`. Images: `power-monitor-api:1.0.0`, `power-monitor-frontend:1.0.0`, and `power-monitor-backup:1.0.0`.
...
Final verification on 2026-07-20 passed 58 portable Python tests (including the
100-device/18,000-record retry load gate), separate live PostgreSQL upgrade,
rollback, and clean-install tests, 5 frontend unit tests, 17 Chromium E2E tests,
...
`20260720_0003`; its encrypted backup passed five artifact checksum checks and
