...
PERMISSION_DEFINITIONS = (
    ...
    _permission(
        ...
        "Compatibility permission for older custom roles; use the granular site permissions.",
        True,
    ),
    _permission(
        "sites.create",
    ...
    _permission(
        ...
        "Sites and devices",
        "Manage firmware",
        "Upload and manage verified firmware artifacts.",
        True,
    ),
    _permission(
        "firmware.deploy",
        "Sites and devices",
        "Deploy firmware",
        "Install, cancel, retry, and intentionally downgrade firmware.",
        True,
    ),
...
PERMISSION_DEPENDENCIES: dict[str, frozenset[str]] = {
    ...
    "sites.create": frozenset({"sites.view"}),
    "sites.edit": frozenset({"sites.view"}),
    "sites.set_default": frozenset({"sites.view"}),
    "sites.disable": frozenset({"sites.view"}),
    "sites.remove": frozenset({"sites.view"}),
    "sites.restore": frozenset({"sites.view"}),
    "sites.transfer_resources": frozenset({"sites.view"}),
    "sites.view_audit": frozenset({"sites.view", "audit.view"}),
    ...
    "firmware.deploy": frozenset({"firmware.view"}),
