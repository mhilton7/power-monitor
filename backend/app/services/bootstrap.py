...
DEFAULT_ALERTS: tuple[tuple[str, str, str, int], ...] = (
    ...
    (
        "Storage continuity reconciling",
        "storage_sequence_reconciling",
        "warning",
        0,
    ),
    (
        "Storage continuity restored",
        "storage_sequence_continuity_restored",
        "info",
        0,
    ),
    ("Storage cursor conflict", "storage_cursor_regression", "critical", 0),
    ("Storage pressure notice", "storage_pressure_notice", "info", 0),
    ("Storage pressure warning", "storage_pressure_warning", "warning", 0),
    ("Storage pressure critical", "storage_pressure_critical", "critical", 0),
    ("Storage pressure emergency", "storage_pressure_emergency", "critical", 0),
    ("Storage cleanup blocked", "storage_cleanup_blocked", "critical", 0),
    (
    ...
    ("Durable storage interval dropped", "storage_interval_dropped", "critical", 0),
