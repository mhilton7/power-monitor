...
class DeviceHeartbeat(Base):
    ...
    current_voltage_volts: Mapped[Decimal | None] = mapped_column(Numeric(14, 4))
    current_amps: Mapped[Decimal | None] = mapped_column(Numeric(14, 4))
    current_power_factor: Mapped[Decimal | None] = mapped_column(Numeric(8, 5))
    current_frequency_hz: Mapped[Decimal | None] = mapped_column(Numeric(8, 3))
    current_energy_wh: Mapped[Decimal | None] = mapped_column(Numeric(20, 3))
    rssi_dbm: Mapped[int | None] = mapped_column(Integer)
    pzem_ok: Mapped[bool] = mapped_column(Boolean)
    pzem_status: Mapped[str] = mapped_column(String(64), default="unavailable")
    pzem_details: Mapped[dict[str, Any]] = mapped_column(JSON, default=dict)
    sd_ok: Mapped[bool] = mapped_column(Boolean)
    sd_status: Mapped[str] = mapped_column(String(64), default="unavailable")
    sd_details: Mapped[dict[str, Any]] = mapped_column(JSON, default=dict)
    card_generation: Mapped[str | None] = mapped_column(String(32))
...
class FirmwareDeployment(Base):
    ...
    source_build_hash: Mapped[str | None] = mapped_column(String(128))
    source_boot_id: Mapped[str | None] = mapped_column(String(80))
    interruption_evidence: Mapped[dict[str, Any]] = mapped_column(JSON, default=dict)
