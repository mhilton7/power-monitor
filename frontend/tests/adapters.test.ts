...
describe('typed homeowner adapters', () => {
  ...
  it('keeps live sensor measurements consistent and distinguishes zero from missing', () => {
    const sensors = adaptSensors([{
      ...
      frequency_hz: '60.0',
      power_factor: '0.83',
      current_energy_wh: '42183',
      pzem_ok: true,
      pzem_status: 'healthy',
      pzem_details: { sample_valid: true, uart_port: 1 },
      sd_ok: false,
      sd_status: 'write_failed',
      sd_details: { mounted: false, writable: false },
      card_generation: '42',
    ...
    expect(sensors[0]).toMatchObject({
      ...
      pzemHealthy: true,
      pzemStatus: 'healthy',
      pzemDetails: { sample_valid: true, uart_port: 1 },
      storageHealthy: false,
      storageStatus: 'write_failed',
      storageDetails: { mounted: false, writable: false },
      cardGeneration: '42',
