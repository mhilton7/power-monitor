...
export const INTERFACE_TEXT_DEFAULTS: Record<string, string> = {
  ...
  'general.dashboard_welcome_subtitle': 'Live energy, device health, synchronization, and estimated Southern California Edison costs across your monitored circuits.',
  ...
  'pages.overview.subtitle': 'Live energy, device health, synchronization, and estimated Southern California Edison costs across your monitored circuits.',
