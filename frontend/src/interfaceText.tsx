...
export const INTERFACE_TEXT_DEFAULTS: Record<string, string> = {
  ...
  'workspace.monitoring.subtitle': 'Manage sensors, physical relationships, and device enrollment.',
  ...
  'workspace.administration.subtitle': 'Manage access, sites, delivery, data, interface, and security.',
