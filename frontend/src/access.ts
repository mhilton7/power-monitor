...
const ADMIN_FALLBACK = new Set([
  ...
  'sites.transfer_resources', 'sites.view_audit', 'utility_accounts.view',
  'utility_accounts.manage', 'network.view', 'network.manage',
  'backups.view', 'backups.create', 'backups.restore', 'logs.export',
