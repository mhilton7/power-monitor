...
| Administration | `users.view`, `users.manage`, `users.manage_protected`, `roles.view`, `roles.manage`, `audit.view`, `settings.view`, `settings.manage`, `interface_text.view`, `interface_text.manage` |
...
| Regular User / Read-Only Viewer (`viewer`) | Overview, Usage, History/export, Costs/export, assigned Sites, Topology, Devices, Rates, and Alerts view. |
