...
Device heartbeat sequence reconciliation is documented in
[DEVICE_SEQUENCE_CURSOR.md](DEVICE_SEQUENCE_CURSOR.md). The heartbeat response
keeps the legacy contiguous acknowledgement and additionally exposes the
server maximum-seen sequence and safe next sequence floor.
